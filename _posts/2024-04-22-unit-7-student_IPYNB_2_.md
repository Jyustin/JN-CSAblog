...
layout: post
title: Unit 7 Lesson
description: ArrayList Lesson AGAIN
...
- ArrayLists are ____dynamic____, meaning their size can grow or shrink as needed, but arrays are static in size
...
- The indicies of an Arraylist start at _0__; If you try to use any value lower than 0, you will get an __indexoutofboundsException____ error
...
ANS: the code will print the max value out of al the items in the Array.
...
## 7.5-7.7 Hacks:
- Write code to remove an element of an ArrayList moving from the first index to the last index, without skipping any lines in the example. 
...
public class Main {
    public static void main(String[] args) {
        ...
        // Removing an element from the ArrayList moving from first to last
        int removedElement = list.remove(0);
        System.out.println("Removed number " + removedElement);
        
        // Sorting the ArrayList using insertion sort
